...
function spt_gap_display() {
    ...
    echo '</select>';
    ?>
    &nbsp;&nbsp;<span class="tooltip" title="<?php _e( 'Choose whether to show a gap between cycles of the marquee content, defaults to \'no\' for classic marquee style, set to \'yes\' for new infinite scrolling style marquee.', 'simple-posts-ticker' ); ?>"><span title="" class="dashicons dashicons-editor-help"></span></span>
    <?php
}
...
function spt_stop_on_hover_display() {
    ...
    echo '</select>';
    ?>
    &nbsp;&nbsp;<span class="tooltip" title="<?php _e( 'Choose whether to disable scroll on mouse hover, defaults to \'no\', set to \'yes\' to stop scroll on mouse hover.', 'simple-posts-ticker' ); ?>"><span title="" class="dashicons dashicons-editor-help"></span></span>
    <?php
}
