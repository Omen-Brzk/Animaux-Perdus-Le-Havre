...
function spt_register_plugin_settings() {
    ...
    add_settings_section('spt_plugin_settings_section', '', null, 'spt_plugin_settings_option');
        ...
        add_settings_field('spt_stop_on_hover', __( 'Disable Stop on Hover:', 'simple-posts-ticker' ), 'spt_stop_on_hover_display', 'spt_plugin_settings_option', 'spt_plugin_settings_section', array( 'label_for' => 'spt-hover' ));
