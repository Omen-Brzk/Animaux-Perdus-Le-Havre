                ...
                <form id="main-form" method="post" action="options.php">
                    ...
                    <div id="spt-shortcode" class="postbox" style="display: none;">
				        ...
				        <div class="inside spt-inside" style="padding-bottom: 15px;">
                            ...
                            <li><strong>on_stop</strong> - choose whether to disable mousehover pause, defaults to "false", set to "true" to enable mousehover pause</li>
                            ...
                            <li><strong>link_class</strong> - set the custom CSS class name for each ticker</li>
                        </div>
                    </div>
