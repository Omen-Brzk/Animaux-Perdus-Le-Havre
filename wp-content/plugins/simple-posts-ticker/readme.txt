...
* **on_stop** - choose whether to disable mousehover pause, defaults to "false", set to "true" to enable mousehover pause
...
* **link_class** - set the custom CSS class name for each ticker
